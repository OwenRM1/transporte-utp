  ...
  ventas.forEach((venta) => {
        ...
        <div id="modal-container" >
          <div id="modal-content">
            ...
            <form id="editar-venta-form">
              ...
              <input type="text" id="di-precio" name="di-precio" value=${venta.precio} />
    ...
    `;
      ...
      btnActualizar?.addEventListener('submit', async (e) => {
        ...
        const apellido = document.querySelector<HTMLInputElement>('#di-apellido')!.value;
        const dni = document.querySelector<HTMLInputElement>('#di-dni')!.value;
        const telefono = document.querySelector<HTMLInputElement>('#di-telefono')!.value;
